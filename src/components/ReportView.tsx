      ...
      <article className="prose-content mb-8">
        {unlocked ? (
          <div className="space-y-4">
            {fullText.split("\n\n").map((paragraph, i) => (
              <p key={i} className="text-foreground leading-relaxed text-[15px]">{paragraph}</p>
            ))}
            ...
            <div className="relative mt-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-transparent via-background/80 to-background">
                <div className="text-center p-8">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-surface-subtle mb-4">
      ...
      <div className="space-y-3">
        {pastReports.map((report) => (
          ...
          >
            ...
            <CheckCircle className="h-3.5 w-3.5 text-primary ml-4 flex-shrink-0" />
          </div>
        ))}
      </div>
    </div>
